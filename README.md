...
#### Linux (64 Bit)
[Tar file](https://github.com/bytemystery-com/vboxssh/releases/download/v0.2.6/VBoxSsh.tar.xz)  
[Standalone binary](https://github.com/bytemystery-com/vboxssh/releases/download/v0.2.6/vboxssh)  
#### Windows (64 Bit)
[Standalone exe](https://github.com/bytemystery-com/vboxssh/releases/download/v0.2.6/VBoxSsh.exe)  
#### Mac
Not available - it could be build but requires Mac + SDK.
#### Android 
[APK](https://github.com/bytemystery-com/vboxssh/releases/download/v0.2.6/VBoxSsh.apk)  
